...
const Contact = () => {
    ...
    return (
        <section className="clean-block clean-form mt-5 p-3 minheight">

            <div className="container d-flex jusfy-content-center flex-column">

                <div className="block-heading mb-3">
                    <h2 className="text-primary h1 mb-2 fw-semibold display-5 border-bottom">Contact Us</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3"><label className="form-label" for="contactNo">Phone No :</label><input id="subject" className="form-control" type="number" name="contactNo" value={query.contactNo} required minLength={10} onChange={onChange} /></div>
                    <div className="mb-3"><label className="form-label" for="message">Message :</label><textarea id="message" className="form-control" name="message" value={query.message} required minLength={10} onChange={onChange}></textarea></div>
                    ...
                    <div className="mb-3 mt-5"><button className="btn btn-primary" type="submit" disabled={query.subject.length < 3 || query.contactNo.length < 10 || query.message.length < 10}>Send</button></div>
                </form>
            </div>
