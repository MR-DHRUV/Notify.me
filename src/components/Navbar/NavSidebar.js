  ...
  return (
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class={location.pathname === '/notes' ? "nav-item active" : 'nav-item'}>
          <Link class="nav-link" to="/notes">
            ...
            <span class="menu-title ms-3">Notes</span>
          </Link>
        </li>
        <li class={location.pathname === '/reminder' ? "nav-item active" : 'nav-item'}>
          <Link class="nav-link" to="/reminder">
            ...
            <span class="menu-title ms-3">Reminders</span>
          </Link>
        </li>
        <li class={location.pathname === '/todo' ? "nav-item active" : 'nav-item'}>
          <Link class="nav-link" to="/todo">
            ...
            <span class="menu-title ms-3">To Do</span>
          </Link>
        </li>
        <li class={location.pathname === '/contact' ? "nav-item active" : 'nav-item'}>
          <Link class="nav-link" to="/contact">
            ...
            <span class="menu-title ms-3">Contact</span>
          </Link>
        </li>
      </ul>
    </nav>
