...
const Signup = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (credentials.password === credentials.cpassword) {
            ...
            const response = await fetch('https://api-data-notify.herokuapp.com/auth/signup/email/verify', {
                method: 'POST',
                headers: {
    ...
    const sendMail = async (event) => {
        ...
        const response = await fetch('https://api-data-notify.herokuapp.com/auth/signup/email', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
