...
const ToDoSate = (props) => {
    ...
    const getAllList = async () => {
        const response = await fetch('https://api-authify.azurewebsites.net/todo/fetch_all_list', {
            method: 'GET',
            headers: {
    ...
    const addList = async (title, date) => {
        ...
        const response = await fetch('https://api-authify.azurewebsites.net/todo/add_list', {
    ...
    const deleteList = async (id) => {
        ...
        //eslint-disable-next-line
        const response = await fetch(`https://api-authify.azurewebsites.net/todo/delete_list/${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'auth-token': localStorage.getItem('token')
    ...
    const editList = async (id) => {
        //API Call
        //eslint-disable-next-line
        const response = await fetch(`https://api-authify.azurewebsites.net/todo/update_existing_list/${id}`, {
